...
const TicketCard = ({ ticket }) => {
  ...
  return (
    <div className="relative w-69 h-80 overflow-hidden bg-white shadow-lg border-t-b-4 border-black rounded-lg transition-transform duration-500 transform hover:-translate-y-4 cursor-pointer">
...
const truncateDescription = (description) => {
  const maxLength = 25; // Maximum length of truncated description
  if (description.length > maxLength) {
    return description.substring(0, maxLength) + "..."; // Truncate the description if it exceeds maxLength
  }
  return description;
};
